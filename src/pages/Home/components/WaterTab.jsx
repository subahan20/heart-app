    ...
    <>
      <Card className="glass-card border-0 shadow-xl overflow-hidden">
        ...
        <CardContent className="space-y-8">
          {isSettingGoal && (
            <div className="p-4 bg-blue-50 rounded-2xl animate-in slide-in-from-top-2 duration-300">
          ...
          <div className="relative group">
            <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-b from-blue-50/50 to-white rounded-3xl border border-blue-100/50 shadow-inner relative">
              <div className="absolute top-4 right-6 text-right">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Goal</p>
                <p className="text-sm font-black text-blue-500 leading-none mt-1">{totalBoxes} <span className="text-[10px]">Glasses</span></p>
              </div>
              ...
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-xl font-bold text-blue-400">glasses</span>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-blue-500 font-medium">1 glass = 250ml</span>
            </div>
            <div className="flex flex-wrap gap-2">
              {[0.25, 0.5, 1, 1.5, 2].map(L => (
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-blue-50 text-blue-600 border border-blue-100 hover:bg-blue-100 hover:border-blue-200 transition-all text-sm font-bold shadow-sm"
                >
                  +{L}L
                </button>
              ))}
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3 min-h-[4rem] p-4 bg-slate-50/50 rounded-3xl border-2 border-dashed border-slate-100">
              {dailyMetrics.water > 0 ? (
                [...Array(dailyMetrics.water)].map((_, i) => (
                  <div
                    key={i}
                    className="group relative h-16 rounded-2xl flex items-center justify-center border-2 border-blue-500 bg-gradient-to-br from-blue-400 to-blue-600 shadow-lg shadow-blue-100 animate-in zoom-in duration-300"
                  >
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3">
            ...
            <Button 
              ...
              disabled={isPastDate}
              className="flex-1 rounded-2xl h-12 bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-200 group"
            >
